...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (0 == mCollapsedHeight) {
            mCollapsedHeight = mTv.getLineHeight() * Math.min(mMaxCollapsedLines,
                    mTv.getLineCount()) + (-mTv.getLayout().getTopPadding()) + mTv.getLayout().getBottomPadding();
        }
...
//        if (mTv != null) {
//            mTv.getViewTreeObserver().addOnPreDrawListener(new OnTVPreDrawListener(mTv));
//        }
    }
    ...
    public void setItemClick(OnItemClickedListener onItemClicked) {
