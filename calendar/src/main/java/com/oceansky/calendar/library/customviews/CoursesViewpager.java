...
import com.oceansky.calendar.library.customviews.DateCalendar.PullCalEvent;
    ...
    public void initParameters() {
        ...
        if (getAdapter() instanceof InfiniteCoursePageAdapter) {
            ...
            if (curserAdapter != null) {
                BaseContentFragment coursesFragment = (BaseContentFragment) curserAdapter.getCurrentFragment();
