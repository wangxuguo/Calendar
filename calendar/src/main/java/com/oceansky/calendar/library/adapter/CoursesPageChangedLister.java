...
public class CoursesPageChangedLister implements ViewPager.OnPageChangeListener {
    ...
    private ArrayList<BaseContentFragment> fragments;
...
//        }
        BaseContentFragment courseFragment = (BaseContentFragment) infiniteCoursePageAdapter.getCurrentFragment();
    ...
    public void refreshFragment(int position) {
        ...
        BaseContentFragment currentFragment = fragments
        ...
        BaseContentFragment prevFragment = fragments
                .get(getPrevious(position));
        BaseContentFragment nextFragment = fragments
    ...
    public void setFragments(ArrayList<BaseContentFragment> fragments) {
