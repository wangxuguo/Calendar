...
import com.oceansky.calendar.library.R;
import com.oceansky.calendar.library.adapter.InfinitePagerAdapter;
import com.oceansky.calendar.library.constant.CaldroidCustomConstant;
import com.oceansky.calendar.library.adapter.CaldroidGridAdapter;
import com.oceansky.calendar.library.adapter.CoursesPageChangedLister;
import com.oceansky.calendar.library.adapter.DatePageChangeListener;
import com.oceansky.calendar.library.adapter.DateWeekPageChangeListener;
import com.oceansky.calendar.library.adapter.InfiniteCoursePageAdapter;
import com.oceansky.calendar.library.adapter.MonthWeekPagerAdapter;
import com.oceansky.calendar.library.fragments.DateGridFragment;
import com.oceansky.calendar.library.listeners.CaldroidListener;
import com.oceansky.calendar.library.listeners.SimpleAnimatorListener;
...
//        monthCalendar = new CalendarViewPager(getContext());
//        weekCalendar = new CalendarViewPager(getContext());
//        addView(monthCalendar);
//        addView(weekCalendar);
    }

    public void init(ViewMode viewmode) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.layout_date_calendar,null);
        monthCalendar = (CalendarViewPager) view.findViewById(R.id.calendar_view_month);
        weekCalendar = (CalendarViewPager) view.findViewById(R.id.calendar_view_week);
        addView(view);
...
//                    + curSelectedDateTime.toString(CaldroidCustomConstant.simpleFormator));
        ...
        if (rowHeight == 0) {
//            View firstChild = View.inflate(getContext(),R.layout_date_calendar.normal_date_cell,null);
