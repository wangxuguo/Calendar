...
public class CaldroidFragment extends DialogFragment {
    ...
    public final static String
            ...
            _TEXT_UNDERLINE_FOR_DATETIME_MAP = "_textUnderlineForDateTimeMap";
    ...
    /**
     * textUnderlineForDateMap holds color for text for each date
     */
    protected Map<DateTime, Integer> textUnderlineForDateTimeMap = new HashMap<>();
    ...
    public Map<String, Object> getCaldroidData() {
        ...
        caldroidData.put(_TEXT_UNDERLINE_FOR_DATETIME_MAP, textUnderlineForDateTimeMap);
    ...
    public void setTextUndelineForDate(int isShow, Date date) {
        DateTime dateTime = CalendarHelper.convertDateToDateTime(date);
        textUnderlineForDateTimeMap.put(dateTime, isShow);
    }

    public void setTextUndelineForDate(Map<DateTime, Integer> showLineForDateTimeMap) {
        textUnderlineForDateTimeMap.putAll(showLineForDateTimeMap);
    }

    public void clearTextUndelineForDate() {
        textUnderlineForDateTimeMap.clear();
    }
    ...
    protected void refreshMonthTitleTextView() {
        ...
        String title = monthTitle.toUpperCase(Locale.CHINA);

        monthTitleTextView.setText(month + "月" + " - " + year);
    }
