 ...
 * Tel:  18500234565
 */
public class BGAHomeworkSelectRefreshViewHolder extends BGARefreshViewHolder {
     ...
     */
    public BGAHomeworkSelectRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            mRefreshHeaderView = View.inflate(mContext, R.layout.view_refresh_header_homework_select, null);
            ...
            if (mPullDownImageResId != -1) {
                ...
                throw new RuntimeException("请调用" + BGAHomeworkSelectRefreshViewHolder.class.getSimpleName() + "的setPullDownImageResource方法设置下拉过程中的图片资源");
            }
            if (mChangeToReleaseRefreshAnimResId != -1) {
                ...
                throw new RuntimeException("请调用" + BGAHomeworkSelectRefreshViewHolder.class.getSimpleName() + "的setChangeToReleaseRefreshAnimResId方法设置进入释放刷新状态时的动画资源");
            }
            if (mRefreshingAnimResId != -1) {
                mMeiTuanRefreshView.setRefreshingAnimResId(mRefreshingAnimResId);
            } else {
                throw new RuntimeException("请调用" + BGAHomeworkSelectRefreshViewHolder.class.getSimpleName() + "的setRefreshingAnimResId方法设置正在刷新时的动画资源");
            }
        }
