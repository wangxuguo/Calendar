...
public class DataCleanUtils {
    ...
    public static void cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(
            ...
            if (externalCacheDir != null) {
                String filePath = externalCacheDir.getPath();
                deleteFolderFile(filePath, true);
            }
        }
    }
    ...
    public static String getCacheSize(Context context) throws Exception {
        ...
        File cacheDir = context.getCacheDir();
        File externalCacheDir = context.getExternalCacheDir();
        long folderSize = getFolderSize(cacheDir) + getFolderSize(externalCacheDir);
        if (folderSize > 0) {
            size = Formatter.formatShortFileSize(context, folderSize);
        }
        return size;
    }
}
