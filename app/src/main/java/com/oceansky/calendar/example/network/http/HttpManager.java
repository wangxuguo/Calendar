...
import com.oceansky.calendar.example.network.model.BindCidRequest;
import com.oceansky.calendar.example.network.model.CreateHomeworkRequest;
import com.oceansky.calendar.example.network.model.FeedBackRequest;
import com.oceansky.calendar.example.network.model.ForgetPwdRequest;
import com.oceansky.calendar.example.network.model.HomeworkAssignRequest;
import com.oceansky.calendar.example.network.model.HomeworkModifyRequest;
import com.oceansky.calendar.example.network.model.HomeworkSelectRequest;
import com.oceansky.calendar.example.network.model.LoginRequest;
import com.oceansky.calendar.example.network.model.ModifyInforRequest;
import com.oceansky.calendar.example.network.model.RegisterRequest;
import com.oceansky.calendar.example.network.model.ResetPwdRequest;
import com.oceansky.calendar.example.network.response.BaseDataEntity;
import com.oceansky.calendar.example.network.response.ClassEntity;
...
import com.oceansky.calendar.example.network.response.CreateHomeworkEntity;
import com.oceansky.calendar.example.network.response.HomeWorkRedPointEntity;
import com.oceansky.calendar.example.network.response.HomeworkClassEntity;
import com.oceansky.calendar.example.network.response.HomeworkEntity;
import com.oceansky.calendar.example.network.response.HomeworkListEntity;
import com.oceansky.calendar.example.network.response.HomeworkPreviewEntity;
import com.oceansky.calendar.example.network.response.HomeworkReuseEntity;
...
import com.oceansky.calendar.example.network.response.ModifyInforEntity;
import com.oceansky.calendar.example.network.response.OrdersEntity;
...
import com.oceansky.calendar.example.network.response.SimpleResponse;
...
import com.oceansky.calendar.example.network.transformer.DefaultSchedulerTransformer;
import com.oceansky.calendar.example.network.transformer.DefaultTransformer;
import com.oceansky.calendar.example.network.transformer.ErrorCheckTransformer;
import com.oceansky.calendar.example.network.response.UploadTokenEntity;
