package com.oceansky.teacher.customviews.pickerview.popwindow;
...
import com.oceansky.teacher.customviews.pickerview.LoopListener;
import com.oceansky.teacher.customviews.pickerview.LoopView;
...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private static final int    DEFAULT_MIN_YEAR    = 1996;
    public static final  int    STYLE_DATE          = 0;
    public static final  int    STYLE_DATE_AND_TIME = 1;
    public static final  String DATE_FORMATER       = "yyyy-MM-dd";
    public static final  String DATE_TIME_FORMATER  = "yyyy.MM.dd HH:mm";
    ...
    private void initView() {
        ...
        cancelBtn = (TextView) contentView.findViewById(R.id.date_tv_cancle);
        confirmBtn = (TextView) contentView.findViewById(R.id.date_tv_confirm);
    ...
    public void onClick(View v) {
        if (v == contentView || v == cancelBtn) {
            ...
            if (null != mListener) {
                ...
                mListener.onDatePickCompleted(year, month, day, hour, minute, sb.toString());
            }
            dismissPopWin();
        }
    }
    ...
    public static long getLongFromyyyyMMdd(String date) {
        SimpleDateFormat mFormat =
                new SimpleDateFormat(style == STYLE_DATE ? DATE_FORMATER : DATE_TIME_FORMATER, Locale.getDefault());
        Date parse = null;
        try {
    ...
    public static String getStrDate() {
        SimpleDateFormat dd = new SimpleDateFormat(style == STYLE_DATE ? DATE_FORMATER : DATE_TIME_FORMATER, Locale.CHINA);
    ...
    public interface OnDatePickedListener {
         ...
         * @param month
         * @param day
         * @param dateDesc yyyy年MM月dd日
         */
        void onDatePickCompleted(int year, int month, int day, int hour, int minute, String dateDesc);
    }
}
