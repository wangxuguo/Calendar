...
public class CustomGridView extends GridView {
    ...
    //LogHelper tag can be at most 23 characters
    private static final String TAG                      = "GridViewHeaderAndFooter";
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = CustomGridView.this.getPaddingLeft() + getPaddingLeft();
    ...
    private static class HeaderViewGridAdapter implements WrapperListAdapter, Filterable {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (DEBUG) {
                LogHelper.d(TAG, String.format("getView: %s, reused: %s", position, convertView == null));
            }
            // Header (negative positions will throw an ArrayIndexOutOfBoundsException)
            int numHeadersAndPlaceholders = getHeadersCount() * mNumColumns;
            if (position < numHeadersAndPlaceholders) {
        ...
        public int getItemViewType(int position) {
            ...
            if (DEBUG) {
                LogHelper.d(TAG, String.format("getItemViewType: pos: %s, result: %s", position, type, mCachePlaceHoldView, mCacheFirstHeaderView));
            }
            return type;
        }
        ...
        public int getViewTypeCount() {
            ...
            if (DEBUG) {
                LogHelper.d(TAG, String.format("getViewTypeCount: %s", count));
            }
            return count;
        }
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (onScrollListener != null) {
                    onScrollListener.onScroll(mDiffY);
                }
                break;
        }
        mStartY = mEndY;
